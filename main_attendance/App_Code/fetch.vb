...
Public Class fetch
    ...
    Public Function checkexcel(ByVal dtexcel As DataTable, ByVal dept As String) As Integer
        ...
        Dim i, compelective, comptype, compdept, flag, count, compaadhar As Integer
        Dim code, elective, type, course(50), aadhar As String
        flag = 0
        count = 0
        ...
        For i = 0 To (dtexcel.Rows.Count - 1)
            ...
            aadhar = Convert.ToString(dtexcel.Rows(i)(5)).ToLower
            ...
            If String.Compare(aadhar, "") <> 0 Then
                compaadhar = 1
            End If

            If compelective And comptype And compdept And compaadhar Then
                flag = 1
                count = count + 1
                course(count) = code
            Else
